...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "34335583028", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("33526585", "33526598"));

		Cliente cli2 = new Cliente(null, "alex", "alexsandro.mpe@gmail.com", "01786978342", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		...
		Pagamento pag2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2022 10:32"),
				null);
